...
app.get('/api/health', (req: Request, res: Response) => {
  res.json({ status: 'ok', service: 'motoris-kalbe-api', timestamp: new Date().toISOString() });
});
...
app.put('/api/products/:id', (req: Request, res: Response) => {
  ...
  products[idx] = {
    ...
    subdist_prices: req.body.subdist_prices !== undefined ? req.body.subdist_prices : products[idx].subdist_prices,
    wilayah: req.body.wilayah !== undefined ? req.body.wilayah : products[idx].wilayah,
  };
